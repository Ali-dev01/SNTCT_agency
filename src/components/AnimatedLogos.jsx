...
const styles = {
  ...
  blurLeft: {
    left: 0,
    background:
      "linear-gradient(90deg, rgba(230, 242, 255, 1) 0%, rgba(230, 242, 255, 0) 100%)",
  },
  blurRight: {
    right: 0,
    background:
      "linear-gradient(270deg, rgba(230, 242, 255, 1) 0%, rgba(230, 242, 255, 0) 100%)", // 270deg for the right side gradient
  },
};
