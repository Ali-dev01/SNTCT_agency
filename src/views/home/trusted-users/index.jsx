  ...
  const testimonials = [
    {
      ...
      role: "CEO, Sadapay",
      content:
        "SNTCT is one of the most powerful multi-vendor script available on CodeCanyon. Support Team behavior is excellent and impressive.",
    ...
    },
    {
      ...
      role: "CEO, Stripe",
      content:
        "SNTCT is one of the most powerful multi-vendor script available on CodeCanyon. Support Team behavior is excellent and impressive. Good Luck :-3 Guuys! You deserve much respect. :-)",
      avatar: "/images/user-1.png",
    },
    {
      name: "Jake",
        ...
        <Box position="relative">
          <Box sx={styles.cardsContainer}>
            {visibleIndexes.map((itemIndex, displayIndex) => {
              ...
              return (
                <Box key={itemIndex} sx={styles.cardWrapper(isCenter)}>
