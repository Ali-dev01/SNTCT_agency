    ...
    return (
        <Container sx={{ pt: { md: "80px", xs: '40px' } }}>
            <Box sx={{ textAlign: 'center', py: { md: '40px', xs: '20px' } }}>
                <GradientHeading text="Strategies for Sustainable Growth" variant="h2" weight={700} sx={styles.heading} />
                <Typography
                    variant="body1"
                    sx={styles.bodyText}
                >
                    At our digital marketing agency, we offer a range of services to<br /> help businesses grow and succeed online.
                </Typography>
                <Box>
                    <ArrowDownSection />
                </Box>
