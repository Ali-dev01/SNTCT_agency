          ...
          <Box mt={7} textAlign="center">
            ...
            <Box mt={2} sx={{ mx: { lg: 16, md: 10, xs: 0 } }}>
              <Typography variant="body1" color="#00336B">
                Welcome to SNTCT. We are dedicated to providing you with exceptional
                digital services, tailored to elevate your brand in the digital world. Our
                Terms and Conditions outline the guidelines and legal agreements for using
                our website and services. By accessing SNTCT’s website and utilizing our
                services, you agree to be bound by these terms, ensuring a transparent and
                trustworthy partnership. Please read them carefully.
              </Typography>
            </Box>
          </Box>
